	...
	<div>
		...
		<div class="pdlr4 pr">
			...
			<div class="orederDetal">
				<ul>
					<li class="fs13 msgLis color6">服务、50-100、5kg以下</li>
				</ul>
			</div>
		</div>
		...
		<div class="pdlr4">
			...
			<div class="orederDetal">
				<ul>
					<li class="flexRowBetween fs13 msgLis color6" v-for="(item,index) in CostDate">
